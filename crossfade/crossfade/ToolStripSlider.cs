...
/// </summary>
[ToolboxBitmap(typeof(ToolStripItem))]
[DefaultEvent("Scroll"), DefaultProperty("BarInnerColor")]
[System.ComponentModel.DesignerCategory("code")]
[ToolStripItemDesignerAvailability(ToolStripItemDesignerAvailability.All)]
public partial class ToolStripSlider : ToolStripItem
{
	#region Events
	...
	public int ThumbSize
	{
		...
		{
			if (value > 0 &
				value < (barOrientation == Orientation.Horizontal ? this.ContentRectangle.Width : this.ContentRectangle.Height))
				thumbSize = value;
			else
	...
	public ToolStripSlider(int min, int max, int value)
	{
		InitializeComponent();
	...
	/// Initializes a new instance of the <see cref="ColorSlider"/> class.
	/// </summary>
	public ToolStripSlider() : this(0, 100, 50) { }
								 ...
								 Color barPenColorPaint, Color elapsedOuterColorPaint, Color elapsedInnerColorPaint)
	{
										...
										gradientOrientation))
		{
			...
			if (mouseEffects && (Selected || mouseInThumbRegion))
	...
	protected override void OnMouseMove(MouseEventArgs e)
	{
		...
		if (Selected & e.Button == MouseButtons.Left)
		{
			...
			float coef = (float)(barMaximum - barMinimum) /
						 (float)
						 ((barOrientation == Orientation.Horizontal ? this.ContentRectangle.Width : this.ContentRectangle.Height) -
						  2 * margin);
